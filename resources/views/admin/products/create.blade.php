        ...
        <form action="{{route('admin.products.store')}}" method="POST" enctype="multipart/form-data">
           ...
           <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <div class="sizes">
                    ...
                    <div>
                        <input type="checkbox" name="sizes[]" value="{{$size->id}}" id="{{$size->name}}" class="d-none sizeCheck" @if(is_array(old('sizes')) && in_array($size->id, old('sizes'))) checked @endif>
           ...
           <div class="form-group mb-3">
                ...
                <div class="colors">
                    ...
                    <div>
                        <input type="checkbox" name="colors[]" value="{{$color->id}}" id="{{$color->name}}" class="d-none colorCheck" @if(is_array(old('colors')) && in_array($color->id, old('colors'))) checked @endif>
           ...
           <div class="form-group mb-3">
                ...
                <textarea name="detail" id="detail" class="form-control @error('detail') is-invalid @enderror"></textarea>
                @error('detail')
                    <span class="invalid-feedback" role="alert" style="display: block">
                        <strong>{{ $message }}</strong>
                    </span>
